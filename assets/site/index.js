...
function component_add(component_type){//write selected component to dom
    ...
    if(component_type == 'component_1'){
        ...
        let div_component = `
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id='${component_id_tracking}_container'>
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id='${component_id_tracking}_a' onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;" ></i></span>
    ...
    if(component_type == 'component_3'){
        ...
        let div_component = `
            <div class="w3-black" style="max-width:935px;width:100%;height:auto; display:flex;margin:auto" id='${component_id_tracking}_container'>
    ...
    if(component_type == 'component_8'){
        ...
        let div_component = `
            <div class="" style="max-width:935px; width:100%;height:auto; margin:0px" id='${component_id_tracking}_container' > 
...
function options_menu(){
    ...
    document.getElementById('menu_or_loading_options_option_menu').innerHTML = `
        ...
        <div style="width: 44%;height: auto;  margin:auto auto 5px 3%;display:inline-block;" class="w3-card">
            ...
            <span style="width: 100%; height: auto;margin: 0px">
                <button onclick="page_templates(1)" style="max-width:277px; width: 96%;height: auto;margin:1% 2%;" class="btn btn-primary">Use template</button>
                <button onclick="" style="max-width:277px; width: 96%;height: auto; margin: 1% 2%;" class="btn btn-success" disabled >Download</button>
            </span>

        </div>

        <div style="width: 44%;height: auto;margin:  auto auto 5px auto;display:inline-block" class="w3-card">
            ...
            <span style="width: 100%; height: auto;margin: 0px;">
                <button onclick="page_templates(2)" style="max-width:277px; width: 96%;height: auto;margin:1% 2%;" class="btn btn-primary">Use template</button>
                <button onclick="window.open('${http_https + current_domain }/templates/files/SimpleDefault _1 9-8-57AM, 10-Jan-2020 CV_Resume.pdf')" style="max-width:277px; width: 96%;height: auto;margin:1% 2%;" class="btn btn-success">Download</button>
            </span>
         ...
         <p style="width: 100%; height: auto;margin: 0px; text-align: center;">Simple/Default 2</p>

         <div style="width: 40%; height: 100px;margin: 16px auto 16px auto;box-shadow: 1px 1px 2px 3px #ccc;background-image:url('${http_https + current_domain }/templates/images/Simple_Default 2.png');background-size:cover" class="w3-border"></div>

         <span style="width: 100%; height: auto;margin: 0px;">
             <button onclick="page_templates(3)" style="max-width:277px; width: 96%;height: auto;margin:1% 2%;" class="btn btn-primary">Use template</button>
             <button onclick="window.open('${http_https + current_domain }/templates/files/SimpleDefault _2 1-7-43AM, 12-Jan-2020 CV_Resume.pdf')" style="max-width:277px; width: 96%;height: auto;margin:1% 2%;" class="btn btn-success">Download</button>
         </span>
...
document.getElementById('menu_or_loading_options_option_menu').innerHTML = `
    ...
    <div style="width: 40%;height: auto; display:inline-block;margin:  auto auto 5px 9%;" class="w3-card">
...
function page_templates(template_number){
    ...
    alert('**TIPS**\nClick on any item to edit or delete it..');
        ...
        <div id="Cv_1_content_container" style="width: 100%;height: auto; margin-top:0px">
            ...
            <div class="" style="max-width:935px;height:100%;height:auto; margin:0px" id="1_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="1_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="2_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="2_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="3_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="3_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="4_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="4_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="5_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="5_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="6_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="6_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="7_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="7_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="8_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="8_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="9_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="9_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="10_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="10_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="12_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="12_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="13_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="13_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="14_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="14_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="15_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="15_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="16_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="16_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="17_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="17_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="18_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="18_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="19_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="19_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="20_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="20_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="21_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="21_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="22_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="22_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="23_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="23_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="24_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="24_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="25_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="25_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="26_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="26_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="27_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="27_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="28_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="28_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="29_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="29_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="30_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="30_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="31_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="31_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="32_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="32_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="33_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="33_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="34_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="34_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="35_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="35_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="36_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="36_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="37_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="37_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="39_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="39_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="46_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="46_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="47_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="47_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="48_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="48_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="49_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="49_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="50_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="50_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="51_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="51_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="52_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="52_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="53_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="53_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="54_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="54_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="55_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="55_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="56_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="56_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="57_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="57_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="58_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="58_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="60_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="60_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="61_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="61_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="62_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="62_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="63_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="63_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="64_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="64_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="65_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="65_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="66_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="66_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="67_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="67_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="68_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="68_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="69_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="69_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="71_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="71_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="72_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="72_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="73_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="73_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="74_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="74_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="75_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="75_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="76_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="76_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="77_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="77_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="78_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="78_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="81_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="81_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="82_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="82_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="83_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="83_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="84_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="84_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="85_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="85_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="86_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="86_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="87_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="87_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="88_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="88_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="89_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="89_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="90_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="90_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="91_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="91_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="92_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="92_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="93_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="93_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="94_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="94_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="95_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="95_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="96_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="96_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="97_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="97_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="98_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="98_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="99_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="99_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="100_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="100_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="101_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="101_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="102_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="102_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="103_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="103_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="104_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="104_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="105_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="105_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="106_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="106_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="107_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="107_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="108_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="108_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="109_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="109_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="110_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="110_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="111_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="111_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="112_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="112_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="113_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="113_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="114_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="114_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="115_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="115_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="116_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="116_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="117_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="117_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="118_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="118_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="119_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="119_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="120_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="120_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="121_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="121_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="122_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="122_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="123_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="123_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
        
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="124_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="124_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="125_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="125_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class="" id="126_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="126_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"> <i class="la la-paper-plane" style="font-size: 16px;"></i></span>
    ...
    if(template_number == 3){
        ...
        <div id="Cv_1_content_container" style="width: 100%;height: auto; margin-top:0px">
            ...
            <div class="" style="max-width:935px;height:auto;height:auto; margin:0px" id="1_container">
                <div style="width: 100%;height: 20px;margin:0px;" class="" id="1_b" onclick="component_space_edit(this.id)">&nbsp;</div>
            </div>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="5_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="5_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"><i class="la la-at" style="font-size: 20px;"></i></span>
                <span style="width:90%;height:auto;margin:0px;font-weight:regular;font-weight:bold" class=""><p id="5_b" style="width: 100%; height: auto; text-align: left; font-size: 18px; color: rgb(41, 43, 44); font-family: Arial, Helvetica, sans-serif; font-weight: 700; font-style: normal; text-decoration: none;" onclick="component_text_edit(this.id)">PERSONAL DETAILS</p></span>
            </div>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="27_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="27_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"><i class="la la-university" style="font-size: 20px;"></i></span>
                <span style="width:90%;height:auto;margin:0px;font-weight:regular;font-weight:bold" class=""><p id="27_b" style="width: 100%; height: auto; text-align: left; font-size: 18px; color: rgb(41, 43, 44); font-family: Arial, Helvetica, sans-serif; font-weight: 700; font-style: normal; text-decoration: none;" onclick="component_text_edit(this.id)">EDUCATION QUALIFICATIONS</p></span>
            </div>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="69_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="69_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"><i class="la la-graduation-cap" style="font-size: 20px;"></i></span>
                <span style="width:90%;height:auto;margin:0px;font-weight:regular;font-weight:bold" class=""><p id="69_b" style="width: 100%; height: auto; text-align: left; font-size: 18px; color: rgb(41, 43, 44); font-family: Arial, Helvetica, sans-serif; font-weight: 700; font-style: normal; text-decoration: none;" onclick="component_text_edit(this.id)">OTHER QUALIFICATIONS</p></span>
            </div>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="81_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="81_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"><i class="la la-industry" style="font-size: 20px;"></i></span>
                <span style="width:90%;height:auto;margin:0px;font-weight:regular;font-weight:bold" class=""><p id="81_b" style="width: 100%; height: auto; text-align: left; font-size: 18px; color: rgb(41, 43, 44); font-family: Arial, Helvetica, sans-serif; font-weight: 700; font-style: normal; text-decoration: none;" onclick="component_text_edit(this.id)">WORK EXPERIENCE</p></span>
            </div>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="106_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="106_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"><i class="la la-comment" style="font-size: 20px;"></i></span>
                <span style="width:90%;height:auto;margin:0px;font-weight:regular;font-weight:bold" class=""><p id="106_b" style="width: 100%; height: auto; text-align: left; font-size: 18px; color: rgb(41, 43, 44); font-family: Arial, Helvetica, sans-serif; font-weight: 700; font-style: normal; text-decoration: none;" onclick="component_text_edit(this.id)">ABOUT ME</p></span>
            </div>
            ...
            <div style="max-width:930px;width:100%;height:auto; display:flex;margin:auto" class=" " id="111_container">
                <span style="min-width:20px;width:3%;height:auto;margin:0px 4px 0px 0px" class="" id="111_a" onclick="selected_div = this.id; show_hide('icon_select_container', 'show');"><i class="la la-phone" style="font-size: 20px;"></i></span>
                <span style="width:90%;height:auto;margin:0px;font-weight:regular;font-weight:bold" class=""><p id="111_b" style="width: 100%; height: auto; text-align: left; font-size: 18px; color: rgb(41, 43, 44); font-family: Arial, Helvetica, sans-serif; font-weight: 700; font-style: normal; text-decoration: none;" onclick="component_text_edit(this.id)">REFERENCE</p></span>
            </div>
